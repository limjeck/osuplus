...
var osuplusUserpage = (function(){
    ...
    function addMostPlayedContent(container){
        ...
        GetPage("https://new.ppy.sh/u/" + userId, function(response){
            var temp = response.match(/var user.*\n/);
            if(temp.length > 0){
                var userInfo = JSON.parse(temp[0].slice(11,-2));
    ...
    function addOsuPreview(){
        songInfoRef.parent().next().after(
            $("<div class='spoiler'></div>").html(
                ...
                $("#osupreview").html("<iframe class='osupreview' src='https://bloodcat.com/osu/preview.html#" + mapID + "' allowfullscreen></iframe>");
