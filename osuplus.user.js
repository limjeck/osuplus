        ...
        $(document.body).append(
            ...
            $("<div id='osuplusModal' style='display:none;'></div>").append(
                ...
                $("<div class='osuplusSettingsContent'>").append(
                    ...
                    $("<div>").append(
                        ...
                        $("<table class='osuplusSettingsTable' width='100%'>").append(
                            ...
                            makeSettingRow("Show Beatconnect mirror", null, makeCheckboxOption("showMirror3")),
                ...
                $("<button id='osuplusSettingsSaveBtn'>Save</button>").click(function(){
                    ...
                    var properties = [
                        "showMirror", "showMirror2", "showMirror3", "showSubscribeMap", "showDates", "showPpRank", "fetchPlayerCountries", "showTop100", "pp2dp", "failedChecked", 
                    ...
                    <table id='songinfo' style='width:100%;'>
                        ...
                        <tr>
                            <td colspan=4><a href=/d/${beatmap.beatmapset_id}>Download</a><br>
                                <a href='http://Chimu.moe/osu/d/${beatmap.beatmapset_id}'>Chimu mirror</a></br>
                      ...
                      <table class='opModal-song-info' style='width:100%;'>
                        ...
                        <tr>
                          <td colspan=4><a href=/beatmapsets/${beatmap.beatmapset_id}/download>Download</a>
                            <a href='http://Chimu.moe/d/${beatmap.beatmapset_id}'>Chimu mirror</a><br>
                            <a href='https://beatconnect.io/b/${beatmap.beatmapset_id}'>Beatconnect mirror</a><br>
                            <a href='https://osu.sayobot.cn/home?search=${beatmap.beatmapset_id}' target='_blank'>Sayobot</a>
                          </td>
                        </tr>
